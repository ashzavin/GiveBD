...
//$reserve=$reserve+$company;
				...
				if(mysqli_num_rows($result)>0){
					...
					if($flag==0){
						...
						if(mysqli_query($con,$sql_query))
						{
							...
							echo "<script type='text/javascript'>location.href = 'dsuccess.php';</script>";
						...
						else
						{
							...
							$message = "$Oops!!! Available Medicine Quantity Limit Exceeds..!";
					 ...
					 {
						        $message = "$Oops..! This medicine has already been selected !!";
							echo "<script type='text/javascript'>alert('$message');</script>";
					 }
				...
				else
				{
					...
					{
						        $message = "$Oops..!! You Can save almost 4 prescriptions. !";
							echo "<script type='text/javascript'>alert('$message');</script>";
					}
				}
			?>
