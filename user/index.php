					...
					<li><a id="active" href="index.html">Home</a></li>
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Medicine Catagory</a>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="medicine.php">General</a></li> 
                ...
                <ul>
					...
					<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        ...
                        <div class="tp-caption small_title customin customout start" style="margin-left:30px;"
                            ...
                            data-endspeed="300"><a href="appointment.html" class="btn btn-dark btn-lg" style="background-color:#ff3300;border:none;">Donate Medicine</a>
                        </div>
                        ...
                        <div class="tp-caption small_title customin customout start" style="margin-left:30px;"
                            ...
                            data-start="1400"
                            data-easing="Back.easeInOut"
                            data-endspeed="300"><a href="paa.php" class="btn btn-dark btn-lg" style="border:none;">Recieve Medicine</a>
                        </div>
 ...
 <div id="map" style="width: 1347px; height: 550px;"></div>
  ...
  <script type="text/javascript">
    var locations = [
      ...
      ['House:132,9/A Dhanmondi', 23.746465, 90.376013, 5],
				...
				<div class="stat f-container">
					...
					<div class="f-element col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<div class="milestone-counter">
                            ...
                            <span class="stat-count highlight"></span>
