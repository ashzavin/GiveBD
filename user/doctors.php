...
<body>
   ...
   <div class="topbar">
	...
	<div class="post-wrapper-top clearfix">
		<div class="container">
			<div class="col-lg-12">
				<h2 style="color: red;">Prescription Saved</h2>
	...
	<div class="white-wrapper">
		...
		<div id="sidebar" class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            	<div class="widget">
                	<div class="title">
                    	<form action="doctor.php"><h2><button type="submit" class="btn btn-primary" style="position:relative; ">Generate More</button></h2></form>
                    </div><!-- end title -->
