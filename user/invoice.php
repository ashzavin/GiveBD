   ...
   <div class="topbar">
	...
	<div class="white-wrapper">
            	...
            	<div class="widget">
					...
					<ul class="recent_posts_widget">
					    ...
					    <i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="prescription.php" data-filter=".outpatient">   All Prescriptions</a><br>
                                           <i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="doctor.php" data-filter=".outpatient">   Generate More</a><br>
		...
		<?php
			...
			$sql_query = "select id,doctor_id,med1,med2,med3,med4,med5,q1,q2,q3,q4,q5,dose1,dose2,dose3,dose4,dose5,patient,page,pgender,dname from prescription where doctor_id like '$email';";
			...
			$sql_query1 = "select name,id from useri where email like '$email';";
        ...
        <div class="big-title clearfix"></div><!-- end big title -->	
            <div class="grid_gallery row" style="box-shadow: 10px 10px 10px 10px #888888;">
				...
				<div class="invoice-header clearfix">
				   <h3> <div class="invoice-logo">
					...
					<div class="invoice-description">
					   ...
					   <strong>Prescription ID:</strong>'.$pid.'<br>
					</div>
				</div><!-- /.invoice-header -->
        ...
        <div class="invoice-info">
            <div class="row">
                <div class="col-sm-4">
				<h4 style="padding-top:20px;">Patient Details</h4>
                    <strong>Name:</strong> '.$patient.'<br>
                    <strong>Age:</strong> '.$page.'<br>
                    <strong>Gender:</strong> '.$pgender.'<br>
					<strong>Disease Name:</strong> '.$dname.'<br><br>
                </div>
        ...
        <div class="invoice-summary clearfix">
            <dl class="dl-horizontal pull-right">
                ...
                <strong>Doctor Signature & Date</strong><br>
				<strong>Doctor ID:</strong> '.$id.'<br>
                <strong>Doctor Name</strong> '.$name.'<br><br>
            </dl>
				...
				<a href="#" class="button" style="margin-top:40px; margin-left:320px;" onclick="HTMLtoPDF()">Generate Pdf</a>
			   ...
			   if($i>0){
			   echo '<div id="sidebar" class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            	<div class="widget">
                	<div class="title">
