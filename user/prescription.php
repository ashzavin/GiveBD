   ...
   <div class="topbar">
	...
	<div class="white-wrapper">
		...
		<div id="sidebar" class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            	<div class="widget">
					...
					<ul class="recent_posts_widget">
                        <li class="asha">
						 <li class="a1">
						<i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="doctor.php"  data-filter=".cardiac">   Generate Prescription</a><br>
		...
		<?php
			...
			<h2 style="font-weight:bold; color: #17C5FF;">Prescription '.$j.'</h2>
