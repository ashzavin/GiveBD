   ...
   <div class="topbar">
		...
		<div class="container">
			<nav class="navbar yamm navbar-default">
				<div class="navbar-header">
                    ...
                    <a href="index.php" class="navbar-brand"><img src="images/logo.png" alt="GiveBd"></a>
	...
	<div class="white-wrapper">
		...
		<div id="sidebar" class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            	<div class="widget">
                	<div class="title">
                    	<h2>Medicine Collections</h2>
                    </div><!-- end title -->
					<ul class="recent_posts_widget">
                        <li class="asha">
						<i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="#"  data-filter=".cardiac">   Antibiotics</a><br>
                        <i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="#"  data-filter=".cardiac">   Fever</a><br>
					    <i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="#" data-filter=".outpatient">   Allergy</a><br>
						<i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="#" data-filter=".pediatric">   Headache</a><br>
						<i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="#" data-filter=".primery">   Cold</a><br>
						<i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="#">   Stomach Pain</a><br>
						<i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="#">   Diarrhea</a><br>
						<i class="fa fa-star"  style="color: #17C5FF; margin-left:20px;"></i><a href="#">   Others</a><br>
...
<?php
			...
			$sql_query = "select generic,company,date,sum(quantity) as total,image from received group by generic;";
            ...
            <div class="input-group" id="boot-search-box">
                ...
                <form method="get" action="a2.php"><input type="text" name="mix" class="form-control" placeholder="Search using generic name or company name" /> </form>
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown dropdown-lg">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" role="menu" >
                                ...
                                <form class="form-horizontal" role="form" method="get" action="a3.php" autocomplete="off">
                                 
 
                                  <div class="form-group autocomplete">
 
                                    <label style="font-weight: bold; color:black;" for="contain">Generic Name of Medicine:</label>
 
                                    <input class="form-control" type="text" name="generic"/>
                                  ...
                                  <div class="form-group auto">
                                    ...
                                    <label style="font-weight: bold; color:black;" for="contain">Company Name of medicine:</label>
                                 ...
                                 <div class="form-group">
                                  ...
                                  <button type="submit" class="btn btn-primary btn-block">Search :: <span class="glyphicon glyphicon-search" aria-hidden="true"></span></button> </form>
			 ...
			 echo ' <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 cardiac">
                        ...
                        <div class="entry">
                            ...
                            <div class="magnifier custom-magnifier">
                                <div class="buttons">
                                    <a class="sg" rel="bookmark" href="blog-single.html" title="Expiry Date: '.$date[$i-1].'" data-toggle="tooltip"><i class="fa fa-link"></i></a>
                                    <a class="st" rel="bookmark" href="#" title="Quantity: '.$quantity[$i-1].'" data-toggle="tooltip"><i class="fa fa-asterisk"></i></a>
                                    <h4>Medicine Company: '.$company[$i-1].'</h4>
						...
						<h5 style="margin-left:50px; margin-top: -10px; margin-bottom:25px;">'.$generic[$i-1].'<h5>
                                              <h5 style="font-size:15px; margin-left:50px; margin-top: -40px; margin-bottom:25px;">Qunatity: '.$quantity[$i-1].'<h5>
                    </div><!-- end col -->';
