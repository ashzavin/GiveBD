...
<body>
   ...
   <div class="topbar">
        	...
        	<div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="topbar_social pull-right">
						...
						<a href="http://givebd.byethost17.com/givebd/pro.php"><i class="fa fa-user"></i> Login/Sign up</a>
	...
	<div class="post-wrapper-top clearfix">
		<div class="container">
			<div class="col-lg-12">
				<h2 style="color: red;">Prescription Saving Failed</h2>
	...
	<div class="white-wrapper">
		...
		<div id="sidebar" class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            	<div class="widget">
                	<div class="title">
                    	<form action="doctor.php"><h2><button type="submit" class="btn btn-primary" style="position:relative; ">Try Again</button></h2></form>
                    </div><!-- end title -->
...
<!--Medicine selection php-->
			<?php
				...
				if(isset($_GET['ok'])){
					...
					$rowcount=0;
					$sql="SELECT * from prescription where doctor_id like 'asha1';";
				...
				if(mysqli_num_rows($result)>0){
					...
					if($flag==0){
						...
						if($company <= $diff){
						$sql_query = "insert into precribed (medname,quantity) values('$name','$company');";  
						...
						$sql1 = "update received set reserve='$company' where generic='$name';";  
