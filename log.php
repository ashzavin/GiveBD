...
<?php
		...
		$email=$password=$category=$kl=$valid="";
		$emailError=$passwordError=$categoryError="";
		if($_SERVER["REQUEST_METHOD"]=="POST")
		{
			...
			if($emailError==""&& $categoryError=="" &&$passwordError=="")
			{
				...
				$sql="Select * FROM useri WHERE email='$email' and category='$category';";
				$result=$con->query($sql);
				...
				if($hash==0)
				{
					$passwordError=$emailError=$categoryError ="email or password invalid or Sign in as is wrong!!";

				}
				else
				{
					$sql="SELECT * FROM useri WHERE
				email='$email' ,category='$category' and password='$hash_pwd';";
			$result=$con->query($sql);
					//include "signup.php";
					$valid = true;
					echo "successfully!!!";
					...
					<li><a href="home.php">Home</a></li>
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Medicine Catagory</a>
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="default.html">For All</a></li>           
                            </ul><!-- end dropdown-menu -->
                        </li><!-- end standard drop down -->
