...
<?php
			...
			$generic= $_SESSION['generic'];
			$company= $_SESSION['company'];
			

			$company = ucfirst($company);
			$generic = ucfirst($generic);
			

			$sql_query = "select generic,company,date,sum(quantity) as total,image from received where generic like '$generic' and company like '$company' group by generic;";
		...
		<?php
            ...
            if($i<=0)
			{
				echo '<div style="color:red; font-weight:bold; margin-left:300px; font-size: 30px;">No Medicine Found</div>';
			}
