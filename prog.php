		...
		<div class="container">
			<nav class="navbar yamm navbar-default">
				...
				<div id="navbar-collapse-1" class="navbar-collapse collapse navbar-right">
					...
					<li><a href="http://givebd.byethost17.com/givebd/index.php">Home</a></li>
    	...
    	<div class="container">
        	<div class="general_row">
				<div class="custom_tab_2 row">
                	...
                	<h3 style="margin-left:10%">Sayma Alam Suha</h3>
                    <p style="margin-left:10%; font-size:20px;">Participate in building healthy Bangladesh</p>
                </div>
				<br>
							...
							<div class="big_team_widget">
                                ...
                                <div class="doctor-details" style="margin-left:5%">
									...
									echo"<ul>
										...
										<li><span>Profession</span> - $speciality</li>
