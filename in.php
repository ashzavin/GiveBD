...
<?php
		...
		if($_SERVER["REQUEST_METHOD"]=="POST")
		{
			...
			else
			{
				...
				$name=validdata($_POST["name"]);
				$sql="SELECT * FROM blk where blklst='$name';"; 
				$result=$con->query($sql);
				if($result->num_rows>0)
				{
					$nameError="You can not register!!!Contact with Admin";
				}
...
$mail->Body    = 
'For making the registration successful click the link<a href="http://givebd.byethost17.com/givebd/ver.php></a>';
...
if(!$mail->send()) {
    ...
    echo 'A message has been sent to the email address.Please check your email for making the registration successful';
}	
